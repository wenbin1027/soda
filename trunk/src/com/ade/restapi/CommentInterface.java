 ...
 */
public abstract class CommentInterface extends ApiInterface {

	public CommentInterface(Parser parser) {
		super(parser);
	}
	...
	protected abstract List<NameValuePair> getParams(String id,String text,Site site);
	/**
	 * 
	 * @param text
	 */
	...
	public HttpUriRequest getRequest(String text, Site site){
		...
		String idEncode=URLEncoder.encode(id);
		...
		List<NameValuePair> data=getParams(idEncode,textEncode,site);
		if (data!=null){
